...
class DataTransformation:
    ...
    def initated_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            print(target_feature_train_data.dtype)
            ...
            # print("input_feature_train_arr shape:", input_feature_train_arr.toarray())
            # print("target_feature_train_data shape:", np.array(target_feature_train_data).reshape(-1, 1) )
            ## Convert in to array to become fast
            train_array = np.c_[input_feature_train_arr,np.array(target_feature_train_data).reshape(-1, 1) ] #Error 2
            test_array = np.c_[input_feature_test_arr,np.array(target_feature_test_data).reshape(-1,1)] #Error 3
